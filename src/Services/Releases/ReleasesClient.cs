...
public class ReleasesClient
{
  ...
  public static readonly int[] MajorVersions = [10, 9, 8, 7, 6];
  ...
  )
  {
    ...
    {
      release = notes!.Releases.Single(_ => SemVersion.Parse(_.Sdk.Version, SemVersionStyles.Any).Equals(version)).Sdk;
    }
